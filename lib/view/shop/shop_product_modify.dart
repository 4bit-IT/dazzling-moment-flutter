                  ...
                  children: [
                          ...
                          Obx(
                            () => Container(
                              ...
                              child: shopController.shopGetMeModel.value.shopProfileImage != null
                                  ? Image(
                                      image: shopController.selectMainImage!.value,
                                      width: 100.w,
                                      height: 100.h,
                                      fit: BoxFit.fill,
                                    )
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        readOnly: shopController.shopGetMeModel.value.name != null,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          border: InputBorder.none,
                          hintText:
                              shopController.shopGetMeModel.value.content == 'null' ? '메인페이지에 보일 간략한 설명을 적어주세요' : null,
                          hintStyle: TextStyle(
                            color: Color(0xffd1d1d6),
                            fontFamily: 'NotoSansCJKKR',
                            fontSize: 14.sp,
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          InkWell(
                                                            onTap: () async {
                                                              await shopController.deleteShopImages(index);
                                                              Get.back();
                                                            },
                                                            child: Container(
                                                              padding: EdgeInsets.fromLTRB(12.w, 12.h, 12.w, 12.h),
                                      ...
                                      child: Stack(
                                        children: [
                                          index == shopController.imagesSize.value
                                              ...
                                              : Image(
                                                  image: shopController.selectImages![index]!,
                                                  width: 100.w,
                                                  height: 100.h,
                                                  fit: BoxFit.fill,
                                                ),
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () async {
                                                          await shopController.onMainOptionDelete(index);
                                                          Get.back();
                                                        },
                                                        child: Container(
                                                          padding: EdgeInsets.fromLTRB(12.w, 12.h, 12.w, 12.h),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              contentPadding: EdgeInsets.all(18.h),
                                              border: InputBorder.none,
                                              hintText: shopController.mainOptionList[index].mainOptionTitleController!
                                                          .value.text ==
                                                      ''
                                                  ? '1. 케이크 맛'
                                                  : null,
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              contentPadding: EdgeInsets.all(18.h),
                                              border: InputBorder.none,
                                              hintText: shopController.mainOptionList[index].mainOptionDescriptionController!.value.text==''?'케이크 맛을 고르는 옵션입니다. 반드시 하나 이상 선택해 주세요.':null,
                                              hintStyle: TextStyle(
                                                color: Color(0xffd1d1d6),
                                                fontFamily: 'NotoSansCJKKR',
                                                fontSize: 14.sp,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Switch(
                                              value:
                                                  shopController.mainOptionList[index].mainOptionAllowMultipleChoices!,
                                              onChanged: (value) {
                                        ...
                                        Obx(() {
                                          if (shopController.mainOptionList.length > index ||
                                            ...
                                            return ListView.builder(
                                                ...
                                                physics: NeverScrollableScrollPhysics(),
                                                itemCount:
                                                    shopController.mainOptionList[index].shopDetailOptionList.length,
